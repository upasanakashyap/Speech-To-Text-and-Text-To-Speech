...
tts_btn = Button(root, text='TTS Conversion', font=('Helvetica', 16), bg='MediumPurple')
tts_btn.place(x=60, y=150)

stt_btn = Button(root, text='STT Conversion', font=('Helvetica', 16), bg='MediumPurple')
...
# Creating the main GUI window
root = Tk()
root.title('Python text to speech and speech to text Converter')
root.geometry('300x300')
root.resizable(0, 0)
root.configure(bg='Salmon')
